  ...
  //console.log(item);
    ...
    $.each(item, function (idx, item) {
      ...
      if (item){
        ...
        var string = '<td><div id="repoCard" class="workFrame" onclick="window.open(' + "'" +  htmlURL + "')" + '"><div class="repoTag"></div><div class="workImage"></div><div class="workText"><div class="workTitle wordwrap">' + repoName + '</div><div class="workSubTitle">' + (repoLanguage == null ? '' : repoLanguage) + '</div><div class="workDescription">' + repoDesc + '</div>' + footer + '</div></div></td>';
